/**
 * 1. use form tag and onSubmit with event (e) from  e access e.target.[name of the input field].value 
 * 
 * 2. controlled element:  use individual field  state for each input field
 * 
 * 3. controller element: one object in a state holding  all the input fields value
 * 
